...
export class Tabs extends CompositeDisposable {
    ...
    private _overflowDropdown = false;

    set overflowDropdown(value: boolean) {
        if (this._overflowDropdown == value) {
            return;
        }

        this._overflowDropdown = value;
    ...
    get overflowDropdown(): boolean {
        return this._overflowDropdown;
    }
    ...
    constructor(
        ...
        this.overflowDropdown = options.overflowDropdown;
